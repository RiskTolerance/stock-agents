...
import { incomeStatementTool } from '../../../tools/layer1_dataCollectionTools/company-statements-tools/income-statement-tool.ts';
...
export const incomeStatementAgent = new Agent({
	...
	Order of operations:
		...
		Fetch data using the incomeStatementTool.
