			...
			<div>
				<div class="flex justify-between items-end mb-2">
					...
					<table class="text-white text-sm">
						<tbody>
							<tr class="flex gap-3">
								<td class="cursor-pointer hover:text-teal-300" onclick={() => console.log('1 day')}
									>1 day</td
								>
								<td class="cursor-pointer hover:text-teal-300" onclick={() => console.log('1 week')}
									>7 days</td
								>
								<td
								...
								<td class="cursor-pointer hover:text-teal-300" onclick={() => console.log('1 year')}
									>1 year</td
								>
							</tr>
						</tbody>
